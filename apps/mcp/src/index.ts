...
const tools: ToolDefinition[] = [
  ...
  { name: 'workspace.members.add', description: 'Add a workspace member by accountId or by email/name.', inputSchema: { type: 'object', properties: { ...workspaceFields(), targetWorkspaceId: { type: 'string' }, accountId: { type: 'string' }, email: { type: 'string' }, name: { type: 'string' }, role: { type: 'string', enum: ['OWNER', 'MEMBER', 'VIEWER'] } }, required: ['role'], additionalProperties: false } },
  { name: 'workspace.members.update', description: 'Change a workspace member role.', inputSchema: { type: 'object', properties: { ...workspaceFields(), targetWorkspaceId: { type: 'string' }, membershipId: { type: 'string' }, role: { type: 'string', enum: ['OWNER', 'MEMBER', 'VIEWER'] } }, required: ['membershipId', 'role'], additionalProperties: false } },
  ...
  { name: 'workspace.invite', description: 'Invite a user to the current workspace by email.', inputSchema: { type: 'object', properties: { ...workspaceFields(), email: { type: 'string' }, role: { type: 'string', enum: ['OWNER', 'MEMBER', 'VIEWER'] } }, required: ['email', 'role'], additionalProperties: false } },
  ...
  { name: 'project.members.add', description: 'Add a project member by accountId or email/name.', inputSchema: { type: 'object', properties: { ...workspaceFields(), projectId: { type: 'string' }, accountId: { type: 'string' }, email: { type: 'string' }, name: { type: 'string' }, role: { type: 'string', enum: ['OWNER', 'MEMBER', 'VIEWER'] } }, required: ['projectId', 'role'], additionalProperties: false } },
  { name: 'project.members.update', description: 'Change a project member role.', inputSchema: { type: 'object', properties: { ...workspaceFields(), projectId: { type: 'string' }, membershipId: { type: 'string' }, role: { type: 'string', enum: ['OWNER', 'MEMBER', 'VIEWER'] } }, required: ['projectId', 'membershipId', 'role'], additionalProperties: false } },
