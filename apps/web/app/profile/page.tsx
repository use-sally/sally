...
export default function ProfilePage() {
  const [profile, setProfile] = useState<{ id: string; name: string | null; email: string; avatarUrl: string | null; pendingEmail: string | null; platformRole?: 'NONE' | 'SUPERADMIN'; emailLocked?: boolean; appearanceFontScale?: number; appearanceTheme?: 'dark' | 'light' } | null>(null)
