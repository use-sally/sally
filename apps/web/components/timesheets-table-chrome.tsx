...
export function TimesheetsFiltersBar({
  ...
  return (
    <div style={{ display: 'grid', gap: 8 }}>
      <div style={{ display: 'grid', gridTemplateColumns: lockedProjectId ? '180px 180px auto' : '180px 180px minmax(180px, 1fr) minmax(180px, 1fr) auto', gap: 8, alignItems: 'center' }}>
